...
type SessionVars struct {
	...
	*UserVars
	...
	// NonTransactionalDMLExecutionMode selects the executor for non-transactional statements.
	NonTransactionalDMLExecutionMode string
	// NonTransactionalDMLConcurrency controls range executor concurrency for non-transactional statements.
...
func NewSessionVars(hctx HookContext) *SessionVars {
	vars := &SessionVars{
		...
		NonTransactionalDMLExecutionMode: DefTiDBNonTransactionalDMLExecutionMode,
		NonTransactionalDMLConcurrency:   DefTiDBNonTransactionalDMLConcurrency,
